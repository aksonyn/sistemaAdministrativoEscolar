...
$query = "INSERT INTO Representantes (idRepresentantes, Nombre, Apellido, Correo, Telefono, Cedula) VALUES ($idRepresentantes, '$Nombre', '$Apellido', '$Correo', '$Telefono', 'Cedula');";
